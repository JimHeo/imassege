...
class MobileNetV2(nn.Module):
    def __init__(self, input_channels, output_stride=8, BatchNorm=None, width_mult=1., pretrained=True):
...
if __name__ == "__main__":
    ...
    model = MobileNetV2(input_channels=3, output_stride=16, BatchNorm=nn.BatchNorm2d)
