...
class BlurDetection(DatasetType):
    def __init__(self, dataset_name="BlurDataset", base_path="dataset"):
    ...
    def parse_data(self, split=0, train_list_file=None, valid_list_file=None):
        image_dataset_path = os.path.join(self.dataset_path, "image")
        mask_dataset_path = os.path.join(self.dataset_path, "gt")
